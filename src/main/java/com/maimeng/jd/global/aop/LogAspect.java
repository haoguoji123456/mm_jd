...
public class LogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, RestController restController) throws Throwable {
        ...
        logger.info("-------------------用户发起请求-----------------");
        logger.info("userId为：" + request.getAttribute(Constant.USERID));
        logger.info("sys为：" + request.getAttribute(Constant.SYS));
        ...
        if (MediaType.APPLICATION_JSON_VALUE.equals(request.getHeader(Constant.CONTENT_TYPE).toLowerCase())) {
